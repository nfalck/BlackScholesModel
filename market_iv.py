...
def create_market_vols(portfolio, rates_by_expiry: dict, chain_fetcher) -> dict:
    """
    ...
    Args:
        ...
        chain_fetcher: cached option chain.
    ...
    for ticker, expiry in ticker_expiry_pairs:
        ...
        chain = chain_fetcher(ticker=ticker, expiry=expiry)
